package com.cx.client.osa.utils;


import com.cx.client.osa.dto.OSAFile;
import com.cx.client.exception.CxOSAException;
...
public class OSAScanner implements Serializable {
    ...
    private CxLoggerAdapter logger;
     ...
     */
    public OSAScanner(String filterPatterns, String archiveInclude, CxLoggerAdapter logger) {
